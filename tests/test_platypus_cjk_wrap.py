...
class CJKWrap(unittest.TestCase):
    ...
    def test1(self):
        ...
        story.append(Paragraph(shortText * 3 + u"This should get broken between some words. " + shortText * 2,style=cjk))


        story.append(Paragraph(shortText * 3 + u"This_should_be_unbroken_as_we_backtrack_to_previous_kanji. " + shortText * 2,style=cjk))

        story.append(Paragraph(shortText + u"This_should_be_broken_in_mid_word_as_we_do_not_backtrack_home_than_half_a_line. " + shortText * 2,style=cjk))
